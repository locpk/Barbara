...
void VulkanApp::createImageView(VkImage image, VkFormat format, VDeleter<VkImageView>& imageView)
{
...
void VulkanApp::createImageViews()
{
	...
	{
		createImageView(image, swapChainImageFormat, swapChainImageViews[index]);
		index++;
	}
}
